...
export const mockSettings: GlobalSettings = savedSettings ? ((): GlobalSettings => {
  ...
  site_title: 'App Store Console',
  meta_description: 'Discover and download the best applications and virtual experiences on our safe review portal.',
  logo_url: '',
  favicon_url: '',
  helpline_whatsapp: '',
  helpline_telegram: '',
  support_email: 'support@example.com',
  disclaimer_text: 'This is a digital software review platform.',
  disclaimer_heading: 'APP REVIEW PLATFORM',
  ethics_discrimination_text: 'We are committed to providing equal access to safe applications.',
  ethics_heading: 'ETHICS & PLATFORM POLICY',
  portal_heading: 'Virtual e-Sports <br/><span class="text-blue-600">Review Portal</span>',
  important_notice_heading: 'VIRTUAL REVIEW HUB',
  ticker_text: 'WELCOME TO THE STORE • Enjoy free reviews and updates •',
  animations_enabled: true,
  seo_keywords: 'app store, review portal, digital downloads',
  about_content: '<p>Our portal is built with a single mission: to provide a transparent environment for discovering applications.</p><p>Explore our catalog of top-rated apps and secure downloads.</p>',
  ...
  terms_content: '<h2>1. General Terms</h2><p>By accessing our portal, you acknowledge that all reviews and applications listed operate purely for entertainment.</p>',
  responsibility_content: '<p>Our website is dedicated to maintaining the highest standards of transparency. We take our responsibility seriously.</p>',
  important_notice: 'Please note: This portal is purely for reviews and indexing.',
