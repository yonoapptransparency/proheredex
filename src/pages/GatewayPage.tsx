  ...
  if (!app) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center px-4 max-w-md mx-auto">
        ...
        <h1 className="text-xl sm:text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-2">Clearance Link Pending</h1>
    ...
    <div className="animate-fade-in select-none pb-20">
      ...
      <div className="max-w-4xl mx-auto mb-12 px-4">
        ...
        <form onSubmit={handleReviewSubmit} className="bg-zinc-50 dark:bg-zinc-800/50 border border-black/5 dark:border-white/5 p-6 sm:p-10 rounded-[32px] mb-12">
          <h3 className="font-semibold mb-6 text-zinc-900 dark:text-zinc-100 text-lg">Leave a Review</h3>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div>
              ...
              <input required type="text" className="w-full bg-white dark:bg-zinc-900 border border-black/10 dark:border-white/10 rounded-xl p-3.5 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500/50 transition-all outline-none font-medium text-zinc-900 dark:text-zinc-100" placeholder="Your name" />
            </div>
            <div>
